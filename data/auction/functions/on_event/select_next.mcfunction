...
execute at @e[tag=Auction.Core] if score $SellerCount Auction matches 0 run tellraw @a[distance=..16] [{"text":"[","color": "white"},{"text":"Auction","color": "dark_purple"},{"text":"] ","color": "white"},{"text": "全てのプレイヤーが出品を完了しました。","color": "white"}]
