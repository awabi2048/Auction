...
# 告知
execute at @e[tag=Auction.Core] if score $SellerCount Auction matches 0 if entity @a[tag=Auction.Seller] run tellraw @a[distance=..16] [{"text":"[","color": "white"},{"text":"Auction","color": "dark_purple"},{"text":"] ","color": "white"},{"text": "最初の出品者は","color": "white"},{"selector":"@a[tag=Auction.Seller]"},{"text": "さんです。","color": "white"}]
...
execute at @e[tag=Auction.Core] unless entity @a[tag=Auction.Seller] run tellraw @a[distance=..16] [{"text":"[","color": "white"},{"text":"Auction","color": "dark_purple"},{"text":"] ","color": "white"},{"text": "全てのプレイヤーの出品が完了しました。出品者はいません。","color": "white"}]
