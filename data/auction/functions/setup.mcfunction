...
# 告知
tellraw @a[tag=Auction.Participant] [{"text":"[","color": "white"},{"text":"Auction","color": "dark_purple"},{"text":"] ","color": "white"},{"text":"入札受付を開始しました！ /acで入札画面を開きます。","color": "yellow","bold": false}]
